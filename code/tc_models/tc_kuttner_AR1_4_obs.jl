...
# ----------------------------------------------------------------------------------------------------------------------
     ...
     Z1a = kron(Matrix(I, 1, 1), [1, 1])';         # Idiosyncratic parts of y        # idio C, idio C+, idio trend
     ...
     ind_trends     = [4]; # GDP trend has drift
     ...
     T = cat(dims=[1,2], [T_c for i=1:1]..., [T_ct for i=1:2]..., [T_c for i=1:1]..., [T_ct for i=1:2]...); 
     Q =  cat(dims=[1,2], [T_c for i=1:1]..., [T_ct for i=1:2]..., [T_c for i=1:1]..., [T_ct for i=1:2]...); 
     ...
     # make T_ind true on the diagonal for idx 1,3,5,6,8. estiamte ar1 coefficients
     for i in [1,3,5,6,8]
          T_ind[i,i] = true;
     end
     ...
     P̄¹    = cat(dims=[1,2], [P̄_c for i=1:1]..., [P̄_ct for i=1:2]..., [P̄_c for i=1:1]..., [P̄_ct for i=1:2]...); # trends have diffuse initial conditions
