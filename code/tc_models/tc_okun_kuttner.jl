# Common and idiosyncratic inflation trend
...
# ----------------------------------------------------------------------------------------------------------------------
     ...
     d   = zeros(n)
     Z   = [ones(n) zeros(n) [zeros(3); ones(3)./σʸ[4:6]]]
     Z1a = kron(Matrix(I, 3, 3), [1, 0, 1])'
     ...
     P̄¹    = cat(dims=[1,2], [P̄_ct for i=1:4]..., [P̄_c for i=1:1]..., [P̄_ct for i=1:2]...)
