...
# ----------------------------------------------------------------------------------------------------------------------
     ...
     T = cat(dims=[1,2], T_c, T_ct, [T_ct for i=1:3]..., T_c, [T_ct for i=1:2]...);
     Q = cat(dims=[1,2], T_c, T_ct, [T_ct for i=1:3]..., T_c, [T_ct for i=1:2]...); 
     ...
     λ     = vcat(λ_c, λ_c, λ_trend, [λ_ct for i=1:3]..., λ_c, [λ_ct for i=1:2]...);
     ρ     = copy(λ);
     λ_ind = λ .!= 0;
     ρ_ind = copy(λ_ind);
