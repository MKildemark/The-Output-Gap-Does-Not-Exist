...
# ----------------------------------------------------------------------------------------------------------------------
     ...
     Z   = [ones(n) [0; ones(n-1)] [zeros(3); ones(n-3)] [zeros(3); ones(n-3)]]; # the common factors in z
     ...
     # Projections
     Z_ind[2:4, [1,2]] .= true; # All        -> efficient gap (not on 5th row because of same loading as 4th row)
